...
@php
    ...
    or 
    <x-micro.genericCard bg="white" :buttonConfig='null' title='title' :btnCard='false' cardHref='javascript:void(0)' addAttr='' :placeholder='true' :cardImgUse='true' cardImgAlt=''>
        innerHtml for $slot
        <x-slot:bottomSlot>
